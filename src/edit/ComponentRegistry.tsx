...
const componentsRegistry: { [index: string]: { defaultProps: {}, defaultLabel: string, getComponent: (props: any) => ReactComponentElement<any> } } = {}
...
export function registerComponent<P extends {}>(registerEntry: ComponentRegisterEntry<P>) {
    componentsRegistry[registerEntry.name] = {
        ...
        getComponent: (config: FormItemConfig) => {
            return (
                <Item label={config.labelName} required={config.required} className={"dynamic-form-item"}>
