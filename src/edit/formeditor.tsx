...
class FormItem extends Component<FormItemConfig> {
    ...
    render() {
        return (
            getComponentConfig(this.props.type).getComponent(this.props)
        );
    }
}

class PreviewFormItemContainer extends Component<PropsWithChildren<{
    onDelete: () => void,
    onCopy: () => void,
    onClick: () => void,
    selected: boolean
    ...
    render() {
        return (<div className={this.props.selected ? "form-item-container selected" : "form-item-container"}
...
class FormEditor extends Component {
    state: { components: FormItemConfig[], visible: boolean } = {
        components: [],
        visible: false
    }
    idGenerator = 1
        ...
        return (
            <div className="form-editor">
                ...
                <div className="preview">
                    <div style={{display: "inline", width: "100%", maxWidth: '900px'}}>
                        <Form className="dynamic-form" layout="vertical">
                            {
                                this.state.components.length === 0 ? (<div className="add-hint">add components</div>) :
                ...
                <Drawer title="Basic Drawer"
                    ...
                    <Input placeholder={this.state.components.filter(l=>l.selected)[0]?.formItemId.toString()}/>
                </Drawer>
            </div>
        );
    }
